    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-12">
      ...
      >
        ...
        <div className="p-8 sm:p-12 min-h-[750px] flex flex-col justify-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">{isLogin ? "Sign In" : "Sign Up"}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Argatyo" className="w-full mt-1 px-4 py-2 border rounded-md border-gray-400" />
                </div>
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-gray-700">
                    Phone Number
            ...
            <div>
              ...
              <input type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder="argatyamagnifuck@gmail.com" className="w-full mt-1 px-4 py-2 border rounded-md border-gray-400" />
            </div>
